...
public final class ThreadPoolManager {
    ...
    // 线程池维护线程的最少数量  
    private static final int SIZE_MIN_POOL = 15;  
    ...
    private final ThreadPoolExecutor mThreadPool =  new ThreadPoolExecutor(SIZE_MIN_POOL,
                                                                           SIZE_MAX_POOL,
                                                                           0L,
    ...
    /*  
     * 将线程池初始化，核心线程数量。  
     * prestartAllCoreThreads设置项，可以在线程池创建，
     * 但还没有接收到任何任务的情况下，先行创建符合corePoolSize参数值的线程数：
     */  
    public void prepare(){
